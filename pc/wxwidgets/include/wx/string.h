...
#undef wxStringToStdWstringRetType
  ...
  bool StartsWith(const wxString& prefix, wxString *rest = NULL) const;
      // check if the string ends with the given prefix and return the
      // beginning of the string before the prefix in the provided pointer if
      // it is not NULL; otherwise return false
  bool EndsWith(const wxString& prefix, wxString *rest = NULL) const;
