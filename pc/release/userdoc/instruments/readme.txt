...
Limitations on PC-Windows : 
   - only VSTi-32bits ( not 64bits ! )
   - only ASIO audio-output, to guarantee low-latency. "Asio4all" is a standard ASIO driver freeware.
   - only one sound-provider per ASIO audio-output ( Windows-OS limitation ...! ).
