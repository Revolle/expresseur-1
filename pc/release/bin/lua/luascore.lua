...
This LUA-module is loaded by default by the bassLUA-eMidi-driver.
This LUA-module contains functions which are driven by the GUI over bassLUA-eMidi-driver :
  - setScore
  - addEvent
  - addEventStarts
  - addEventStops
